...
/* EDIT_BUF es un array en C (segmento EDITBSS, $3900-$3AFF) */
#define EDIT_BUF_SIZE   512
#define EDIT_BUF_ADDR   0x3900
#define EDIT_BUF       EDIT_BUF_ADDR
extern unsigned char edit_buf[EDIT_BUF_SIZE];
#define STATE_ADDR      0x0600
#define LINE_IDX_ADDR   0x0640        /* 128 bytes - 64 entradas de uint16_t */
#define LINE_IDX_MAX    64
#define SCRATCH_ADDR    0x06C0        /* 56 bytes - temporal para MFS */
#define YANK_BUF_ADDR   0x0700        /* 64 bytes */
#define TEMP_LINE_ADDR  0x0740        /* 64 bytes */
#define STACK_AREA      0x0780
