...
/* ==========================================================================
   mfs_init_wrapper - Inicializa SD y monta MicroFS
   Llamada desde startup.s
   ========================================================================== */
void mfs_init(void) {
    uint8_t res;
    ...
    res = rom_sd_init();
    if (res != SD_OK) {
        /* Error SD: no podemos hacer mucho, intentar de todas formas */
        return;
    }
...
/* ==========================================================================
   str_to_upper - Convierte string a mayúsculas in-place
   (MicroFS es case-sensitive, todo en mayúsculas)
   ========================================================================== */
